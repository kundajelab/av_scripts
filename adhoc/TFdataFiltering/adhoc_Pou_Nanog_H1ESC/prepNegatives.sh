...
/scratch/avanti/av_scripts/exec/recenterSequences.py --outputFile $CENTERED_OUTPUT_FILE".gz" --sequencesLength $WINDOW --chromSizesFile ../hg19_chromsizes.txt ${OUTPUT_FILE}".gz"
